...
import argparse
import torch
from src4.env import create_train_env
from src4.model import ActorCritic
from src4.process import local_train, local_test
from src4.glob_optim import GlobalAdam as optim
import torch.multiprocessing as _mp
import shutil

def get_args():
    parser = argparse.ArgumentParser(""" Implementation of the paper Hindsight Policy Gradients """)
    ...
    parser.add_argument("--device", type=str, default="cpu", help="Device to run the model on, either 'cpu' or 'cuda'")
